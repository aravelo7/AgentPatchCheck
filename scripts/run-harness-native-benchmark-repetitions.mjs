...
function parseArguments(argv) {
	...
	if (outputRoot === undefined || model === undefined || runs === undefined)
		throw new Error(
			"Usage: npm run benchmark:harness-native-repetitions -- --output-root <new-directory> --runs <2-20> --model <model> [--provider-profile <profile>] [--suite-version <v1|v2|v3|v4>] [--quality-gate <path>]",
		);
